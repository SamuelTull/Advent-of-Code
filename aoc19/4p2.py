...
for dr in range(10):
    ...
    # position 2
    for d0 in range(dr):
        for d1 in range(d0, dr):
            for d2 in range(dr + 1, 10):
                for d3 in range(d2, 10):
                    S.add(
    ...
    for d0 in range(dr):
        for d1 in range(d0, dr):
            for d2 in range(d1, dr):
                for d3 in range(dr + 1, 10):
                    S.add(
